...
int main() {
  ...
  //{{{ final normalisation
  dispatch_i(p_plsum, di_1,   b_x0, b_lmean, b_indir);
  dispatch_i(p_lvari, di_768, b_x0, b_lmean, b_xtmp, b_indir);
  dispatch_i(p_plsum, di_1,   b_xtmp, b_lvari, b_indir);
  dispatch_i(p_lnorm, di_768, B(b_lnfw), B(b_lnfb), b_lmean, b_lvari, b_x0, b_x1, b_indir);
  //}}}
